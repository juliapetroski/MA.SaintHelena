...
These four runs are a 2x2 factorial cross of two future projected scenarios (SSP1-2.6 and SSP3-7.0) with a historical hindcast from 2015, and forcing by two atmospheric CMIP6 models (CNRM-CM6-1-HR and GFDL-ESM4) produced by @artioli23.
...
The optimization process returned an overall likelihood of 0.764 for CNRM SSP1-2.6, 0.767 for CNRM SSP3-7.0, 0.754 for GFDL SSP1-2.6, 0.750 for GFDL SSP3-7.0. 
...
files <- list(
  "Files/Fitting_updated/model_target_annualresults_plus_chi-2010-2019-CNRM-ssp126.csv",
  "Files/Fitting_updated/model_target_annualresults_plus_chi-2010-2019-CNRM-ssp370.csv",
  "Files/Fitting_updated/model_target_annualresults_plus_chi-2010-2019-GFDL-ssp126.csv",
  "Files/Fitting_updated/model_target_annualresults_plus_chi-2010-2019-GFDL-ssp370.csv")
...
knitr::include_graphics("Files/Fitting_updated/Saint_Helena_MA_updated_2010-2019_CNRM-ssp126_compare_plot.png")
```
...
knitr::include_graphics("Files/Fitting_updated/Saint_Helena_MA_updated_2010-2019_CNRM-ssp370_compare_plot.png")
```
...
knitr::include_graphics("Files/Fitting_updated/Saint_Helena_MA_updated_2010-2019_GFDL-ssp126_compare_plot.png")
```
...
knitr::include_graphics("Files/Fitting_updated/Saint_Helena_MA_updated_2010-2019_GFDL-ssp370_compare_plot.png")
```
